    ...
    public partial class LoginForm : Form
    {
        ...
        private void loginButton_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                String query = "SELECT * FROM patients WHERE username = '" + username + "'";
                ...
                if (reader.Read())
                {
                    ...
                    string query2 = "SELECT password FROM patients WHERE username = '" + username + "'";
                    String pass;
                    ...
                    if (c == 20)
                    {
                        var patient_view = new PatientForm();                            
                        patient_view.Show();
                        this.Hide();
                    }
                    else
